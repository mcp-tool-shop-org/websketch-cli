...
- [ ] `[cli|mcp|desktop]` SKIP: read-only CLI — renders, diffs, and fingerprints captures; no destructive actions
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (reads input JSON, writes to stdout or user-specified output) (2026-02-27)
...
- [x] `[cli]` Exit codes: 0 ok · 1 user error · 2 runtime error · 3 partial success (0=success, 1=validation, 2=filesystem) (2026-02-27)
...
- [ ] `[cli|mcp|desktop]` SKIP: simple CLI tool — no logging levels needed
- [ ] `[mcp]` SKIP: not an MCP server
